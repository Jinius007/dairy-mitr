...
ME (Mcal/day)
0.097 × BW^0.75
0.097 × 400^0.75 = 0.097 × 101.6 = 9.85 Mcal/day
DCP (g/day)
3.0 × BW^0.75
3.0 × 101.6 = 304.8 g/day
TDN (kg/day)
Approx 0.0227 × BW^0.75
≈ 2.3 kg/day
...
FCM (kg) = Actual milk (kg) × [0.4 + (0.15 × Fat%)]

Example 1: 8 kg milk with 4% fat → FCM = 8 × [0.4 + (0.15 × 4)] = 8 × 1.0 = 8.0 kg FCM
Example 2: 8 kg milk with 7% fat (buffalo) → FCM = 8 × [0.4 + (0.15 × 7)] = 8 × 1.45 = 11.6 kg FCM
...
ME per kg FCM
1.188 Mcal/kg FCM
1.188 × 8 = 9.50 Mcal/day
DCP per kg milk at 4% fat
50 g DCP/kg milk
50 × 8 = 400 g DCP/day
DCP at other fat %
Use: DCP(g) = (Milk protein g / 0.70) per kg milk
where Milk protein% = 1.9 + 0.4×Fat%
At 4% fat: protein = 1.9+(0.4×4)=3.5%; DCP = (35/70)×100 = 50g/kg
...
MINIMIZE: Cost = (price of ingredient 1 × amount) + (price of ingredient 2 × amount) + ...
...
Body weight estimation (girth tape method): BW (kg) ≈ (Heart Girth in cm)² × length (cm) / 10,840
...
FCM = 9 × [0.4 + (0.15 × 4%)] = 9 × [0.4 + 0.6] = 9 × 1.0 = 9.0 kg FCM/day
...
9.97
308
ME = 0.097 × 420^0.75; DCP = 3.0 × 420^0.75
Milk Production
9 kg FCM
10.69
450
